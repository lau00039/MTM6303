<?php
/**
 * Template part for displaying contact content in contact.php
 *
            ...
            <div class="col-xs-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 col-md-offset-1">
                        ...
                        <h3>Head Office</h3>
                        <?php
                            $addr = "1385 Woodroffe Ave<br/>Nepean, ON K2G"
                        ?>
                            <address>
                                <p>
                        ...
                        <div class="mapouter">
                          ...
                          <div class="gmap_canvas"><iframe width="600" height="500" id="gmap_canvas"
                              ...
                              <?php echo urlencode(strip_tags(mtm6303final_get_dynamic_sidebar ('mtm6303-sidebar-location'))) ?>&t=&z=13&ie=UTF8&iwloc=&output=embed"
